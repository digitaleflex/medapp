...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($auth->login($email, $password)) {
        ...
        // URL de redirection - définie dans la méthode login de Auth
        $redirect = isset($_SESSION['redirect_url']) ? $_SESSION['redirect_url'] : 'index.php';
        unset($_SESSION['redirect_url']); // Nettoyer la session après utilisation
        
        // Ajouter le chemin relatif si nécessaire
        if (strpos($redirect, 'http') !== 0 && $redirect[0] !== '/') {
            $redirect = $root_path . $redirect;
        }
        
        // Stocker la redirection pour l'authentification Google aussi
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="form-container">
                ...
                <div class="px-6 pt-12 pb-6">
                    ...
                    <!-- Bouton de connexion Google sans type spécifique, détectera automatiquement le type basé sur l'email -->
